...
This project is indexed by GitNexus as **SuCoder** (1416 symbols, 3576 relationships, 125 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Work in the Tests area (304 symbols) | `.claude/skills/generated/tests/SKILL.md` |
| Work in the Sucoder area (260 symbols) | `.claude/skills/generated/sucoder/SKILL.md` |
