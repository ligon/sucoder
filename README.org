...
* Project Overview
Unix user and group permissions have been battle-tested for over fifty years.  When you bring on a new collaborator you give them their own account, set group read on the shared repo, and let the filesystem enforce the boundaries.  Why should an AI coding agent be any different?
