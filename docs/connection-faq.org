...
No --- and they can't.  Two things break them, and the second is the more
common culprit:

1. *Suspend tears down the network stack*, so the TCP connections under
   the ControlMaster sockets die and the cluster drops them.
